...
SELECT 
    ...
    pr.category,
    pr.total_units_sold,
    ROUND((pr.revenue / tr.overall_revenue) * 100, 2) AS revenue_contribution_percentage
...
-- Business Scenario: 
-- Marketing wants to target high-value customers. Segment customers into 'High Value' (>₹50,000 spent), 'Medium Value' (₹20,000-₹50,000),
